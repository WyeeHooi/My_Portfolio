...
const FallingText = ({
    ...
    useEffect(() => {
        ...
        const newHTML = words
            .map((word) => {
                ...
                return `<span
          class="inline-block mx-[2px] select-none ${isHighlighted ? "text-cyan-400 font-bold" : ""
                    }"
        >
          ${word}
        </span>`;
    ...
    return (
        <div
            ref={containerRef}
            className="relative z-[1] w-full h-full cursor-pointer text-center pt-8 overflow-hidden md:display sm:hidden"
