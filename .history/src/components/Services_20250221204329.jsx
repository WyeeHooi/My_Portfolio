    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[50rem] mb-5 p-8 border border-n-1/30 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] lg:h-[50rem] sm:h-[30rem]">
