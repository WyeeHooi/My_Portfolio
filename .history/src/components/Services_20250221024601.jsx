            ...
            <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
              ...
              <ul>
                {collabApps.map((app, index) => (
                  ...
                  >
                    <div
                      className={`relative -top-[1.6rem] flex w-[4rem] h-[4rem] bg-n-7 border group border-n-1/15 rounded-xl -rotate-${index * 45
                        }`}
                    >
                      <img
                        ...
                        src={app.icon}
                      />
                      <span className="absolute mt-10 bottom-0 left-1/2 -translate-x-1/2 translate-y-2 opacity-0 group-hover:opacity-100 bg-black text-n-2 text-xs px-2 py-1 rounded-lg transition-opacity duration-300">
                        {app.title}
                      </span>
                    </div>
                  </li>
