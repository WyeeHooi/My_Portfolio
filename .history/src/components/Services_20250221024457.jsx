                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        src={app.icon}
                      />
                      <span className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2 opacity-0 group-hover:opacity-100 bg-black text-n-4 text-xs px-2 py-1 rounded-lg transition-opacity duration-300">
                        {app.title}
                      </span>
                    </div>
                  </li>
