      ...
      <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] ">
        ...
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem] grid grid-flow-row md:grid-flow-col">
          ...
          <div className="grid-cols-12 lg:grid-cols-6 md:grid-cols-8">
            ...
            Web Developer | <br /><span className="text-color-5 h2">Turning Ideas into Reality</span>           
          </h1>
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
          Hi, I’m <span className="text-color-5 text-black">Hooi Yee</span>! I craft sleek, user-friendly websites that deliver seamless experiences.
          </p>
          </div>
