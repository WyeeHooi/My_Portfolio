        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/30 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
              ...
              {/* <ul className="relative w-[30rem] h-[30rem]">
                {collabApps.map((app, index) => (
                  ...
                  >
                    <div
                      className={`relative -top-[1.6rem] flex w-[5rem] h-[5rem] bg-n-7 border group border-n-1/15 rounded-xl -rotate-${index * 45
                        }`}
                    >
                      <img
              ...
              <ul className="relative w-[25rem] h-[25rem]">
                {collabApps.map((app, index) => (
                  <li
                    key={app.id}
                    className={`absolute top-1/2 left-1/2 h-[5rem] w-[5rem] 
      -translate-x-1/2 -translate-y-1/2 
      rotate-[${(index * 360) / collabApps.length}deg]`}
                  >
        ...
        bg-n-7 border border-n-1/15 rounded-xl">
          ...
          group-hover:opacity-100 bg-black text-white text-xs px-2 py-1 rounded-lg 
