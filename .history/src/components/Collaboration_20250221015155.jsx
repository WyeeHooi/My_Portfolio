    ...
    <Section crosses>
      <div className="container grid md:grid-flow-col">
        <div className="md:grid-cols-6">
          ...
          <p className="leading-loose">Hello! I’m currently pursuing a <b>Bachelor of Computer Science</b>. My journey in tech is driven by a passion for creating innovative and user-friendly applications that make a real impact. I thrive on the satisfaction of achieving meaningful outcomes through my work.
